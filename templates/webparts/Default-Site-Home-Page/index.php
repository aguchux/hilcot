			...
			<li>
				...
				<div class="container">
					<div class="wrap-caption">
						<?php if (strlen($slider->top_title > 2)) : ?>
						...
						<a href="/info/<?= $PageLink->slug ?>" class="btn btn-secondary" title="<?= $slider->button_text ?>"><?= $slider->button_text ?></a>
					</div>
				</div>
			</li>
		<?php endwhile; ?>
		...
		<div class="row">
			<div class="col-sm-5 col-md-5">
				<div class="director-image">
					...
					<img class="editable" src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 12, "{$assets}images/director.png") ?>" data-height="676" data-width="580" id="<?= "{$PageInfo->id}-{$page_part->id}-12" ?>" data-type="img">
				</div>
		...
		<div class="row grid-services">
			<div class="col-sm-6 col-md-4 eco manufacturing gas">
				<div class="box-image-4">
					<a>
						<div class="media">
							<img date-height="570" data-width="400" id="<?= "{$PageInfo->id}-{$page_part->id}-181" ?>" data-type="img" src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 181, "{$assets}images/project-img-1.jpg") ?>" class="img-responsive editable">
						</div>
						<div class="body">
							<div class="content">
			...
			<div class="col-sm-6 col-md-4 manufacturing gas">
				<div class="box-image-4">
					<a>
						<div class="media">
							<img date-height="570" data-width="400" id="<?= "{$PageInfo->id}-{$page_part->id}-182" ?>" data-type="img" src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 182, "{$assets}images/project-img-2.jpg") ?>" class="img-responsive editable">
						</div>
						<div class="body">
							<div class="content">
			...
			<div class="col-sm-6 col-md-4 industry factory">
				<div class="box-image-4">
					<a>
						<div class="media">
							<img date-height="570" data-width="400" id="<?= "{$PageInfo->id}-{$page_part->id}-183" ?>" data-type="img" src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 183, "{$assets}images/project-img-3.jpg") ?>" class="img-responsive editable">
						</div>
						<div class="body">
							<div class="content">
			...
			<div class="col-sm-6 col-md-4 industry factory">
				<div class="box-image-4">
					<a>
						<div class="media">
							<img date-height="570" data-width="400" id="<?= "{$PageInfo->id}-{$page_part->id}-184" ?>" data-type="img" src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 184, "{$assets}images/project-img-4.jpg") ?>" class="img-responsive editable">
						</div>
						<div class="body">
							<div class="content">
			...
			<div class="col-sm-6 col-md-4 industry oil">
				<div class="box-image-4">
					<a>
						<div class="media">
							<img date-height="570" data-width="400" id="<?= "{$PageInfo->id}-{$page_part->id}-185" ?>" data-type="img" src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 185, "{$assets}images/project-img-5.jpg") ?>" class="img-responsive editable">
						</div>
						<div class="body">
							<div class="content">
			...
			<div class="col-sm-6 col-md-4 eco">
				<div class="box-image-4">
					<a>
						<div class="media">
							<img date-height="570" data-width="400" id="<?= "{$PageInfo->id}-{$page_part->id}-186" ?>" data-type="img" src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 186, "{$assets}images/project-img-6.jpg") ?>" class="img-responsive editable">
						</div>
						<div class="body">
							<div class="content">
			...
			<div class="col-sm-6 col-md-4 eco gas">
				<div class="box-image-4">
					<a>
						<div class="media">
							<img date-height="570" data-width="400" id="<?= "{$PageInfo->id}-{$page_part->id}-187" ?>" data-type="img" src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 187, "{$assets}images/project-img-7.jpg") ?>" class="img-responsive editable">
						</div>
						<div class="body">
							<div class="content">
			...
			<div class="col-sm-6 col-md-4 eco">
				<div class="box-image-4">
					<a>
						<div class="media">
							<img date-height="570" data-width="400" id="<?= "{$PageInfo->id}-{$page_part->id}-188" ?>" data-type="img" src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 188, "{$assets}images/project-img-8.jpg") ?>" class="img-responsive editable">
						</div>
						<div class="body">
							<div class="content">
			...
			<div class="col-sm-6 col-md-4 oil">
				<div class="box-image-4">
					<a>
						<div class="media">
							<img date-height="570" data-width="400" id="<?= "{$PageInfo->id}-{$page_part->id}-189" ?>" data-type="img" src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 189, "{$assets}images/project-img-9.jpg") ?>" class="img-responsive editable">
						</div>
						<div class="body">
							<div class="content">
...
<!-- TESTIMONIALS -->
<div class="section testimony bglight mt-5">
	<div class="container">
...
<div class="section blog">
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-12 col-md-12">
				<h2 class="section-heading editable" id="<?= "{$PageInfo->id}-{$page_part->id}-42" ?>" data-type="text"><?= $Core->getCMS($PageInfo->id, $page_part->id, 42, "RECENT NEWS") ?></h2>
			</div>
		...
		<div class="row">
			...
			<div class="col-sm-2 col-md-2">
				<div class="client-img">
					<img src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 49, "{$assets}images/partners-1.png") ?>" id="<?= "{$PageInfo->id}-{$page_part->id}-49" ?>" data-type="img" data-width="205" data-height="50" class="img-responsive editable">
				</div>
			</div>

			<div class="col-sm-2 col-md-2">
				<div class="client-img">
					<img src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 44, "{$assets}images/partners-2.png") ?>" id="<?= "{$PageInfo->id}-{$page_part->id}-44" ?>" data-type="img" data-width="205" data-height="50" class="img-responsive editable">
				</div>
			</div>

			<div class="col-sm-2 col-md-2">
				<div class="client-img">
					<img src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 45, "{$assets}images/partners-3.png") ?>" id="<?= "{$PageInfo->id}-{$page_part->id}-45" ?>" data-type="img" data-width="205" data-height="50" class="img-responsive editable">
				</div>
			</div>

			<div class="col-sm-2 col-md-2">
				<div class="client-img">
					<img src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 46, "{$assets}images/partners-4.png") ?>" id="<?= "{$PageInfo->id}-{$page_part->id}-46" ?>" data-type="img" data-width="205" data-height="50" class="img-responsive editable">
				</div>
			</div>
