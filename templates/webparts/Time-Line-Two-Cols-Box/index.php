            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="history-2">
                    <div class="timeline__item">
                        <div class="media editable" id="<?= "{$PageInfo->id}-{$page_part->id}-1" ?>" data-type="img" data-height="400" data-width="600"><img src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 1, "{$assets}images/history-2.jpg") ?>" class="img-responsive"></div>
                        <div class="aksen"></div>
                        <div class="text">
