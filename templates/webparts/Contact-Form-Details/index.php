        ...
        <div class="row">
            <div class="col-sm-4 col-md-4 col-md-push-8">
                ...
                <div class="widget contact-info-sidebar">
                    ...
                    <ul class="list-info">
                        ...
                        <li>
                            <div class="info-icon">
                                <span class="icofont icofont-brand-whatsapp"></span>
                            </div>
                            <div class="info-text editable" id="<?= "{$PageInfo->id}-{$page_part->id}-31" ?>" data-type="text"><?= $Core->getCMS($PageInfo->id, $page_part->id, 31, "(0761) 654-123987") ?></div>
                        </li>
                        <li>
                            <div class="info-icon">
            ...
            <div class="col-sm-8 col-md-8 col-md-pull-4">
                <div class="content">
                    ...
                    <form action="/forms/contactquote" class="form-contact" id="contactForm" data-toggle="validator" novalidate="true" method="POST">
                        ...
                        <div class="form-group">
                            <div id="success"></div>
                            <button type="submit" class="btn btn-secondary" style="pointer-events: all; cursor: pointer;">CONTACT US</button>
                        </div>
                    </form>
