			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-6">
					<div class="vidimg">
						...
						<img id="<?= "{$PageInfo->id}-{$page_part->id}-10" ?>" data-type="img" src="<?= $Core->getCMS($PageInfo->id, $page_part->id, 10, "{$assets}images/welcome-img.jpg ") ?>" class="img-responsive editable">
					</div>
				</div>
