                        ...
                        <div class="topbar-right">
                            <ul class="topbar-menu">
                                <?php while ($tlink = mysqli_fetch_object($Cat1Pages)) : ?>
                                    <li><a href="/<?= $Core->PageBase($tlink->type) ?>/<?= $tlink->slug ?>"><?= $tlink->menutitle ?></a></li>
                                <?php endwhile; ?>
                            </ul>
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" style="z-index: 9999999;">
                                            <?php while ($subpage = mysqli_fetch_object($SubPages)) : ?>
                                                <li><a href="/<?= $Core->PageBase($subpage->type) ?>/<?= $subpage->slug ?>"><?= strtoupper($subpage->menutitle) ?></a></li>                                          
                                            <?php endwhile; ?>
                                        </ul>
                                    </li>
                                <?php else : ?>
                                    <li><a href="/<?= $Core->PageBase($page->type) ?>/<?= $page->slug ?>" title="<?= $page->title ?>"><?= strtoupper($page->menutitle) ?></a></li>
                                <?php endif; ?>
                            ...
                            <?php if ($Me->auth) : ?>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" style="z-index: 9999999;">
                                        ...
                                        <li><a href="/dashboard/sliders">Slides</a> </li>
                                        <li><a href="/dashboard/gallery">Photo Gallery</a> </li>
                                        <li><a href="/dashboard/testimonies">Testimonies</a> </li>
