<div class="section overlap info">
    <div class="container">
        ...
        <legend class="mb-3">Edit Page
            <a class="pull-right btn btn-mini btn-success" href="/dashboard/pages/<?= $PageInfo->id ?>/webparts"><span>+Add Web Parts</span></a>
        </legend>
        <hr />

        <form action="/forms/editpage" method="POST" enctype="multipart/form-data">
            <?= $Me->tokenize() ?>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3 form-group">
                    ...
                    <select name="type" required class="form-control form-control-lg">
                        ...
                        <option value="gallery" <?= $PageInfo->type == "gallery" ? 'selected="selected"' : '' ?>>Gallery Page</option>
                    </select>
                </div>
                <div class="col-12 col-md-3 form-group">
