<div class="section overlap info">
    <div class="container">
        ...
        <form action="/forms/editslider" method="POST" enctype="multipart/form-data">
            <?= $Me->tokenize() ?>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-12 form-group">
                    ...
                    <input name="toptitle" class="form-control form-control-lg" type="text" value="<?= $SliderInfo->top_title ?>" placeholder="Top Title">
                </div>
