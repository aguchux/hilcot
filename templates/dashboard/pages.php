<div class="section overlap info">
    <div class="container">
        ...
        <legend class="mb-3">Site Pages <small>list pages</small>
            <a class="pull-right btn btn-mini btn-success" href="/dashboard/addpage"><span>+Add Page</span></a>
        </legend>
        ...
        <div>
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><?= $pg->title; ?></td>
                    <td>
                        <a href="/dashboard/pages/<?= $pg->id; ?>/webparts">Web Parts</a> |
                        <a href="/dashboard/pages/<?= $pg->id; ?>/editpage">Edit</a> |
                        <a href="/dashboard/pages/<?= $pg->id; ?>/deletepage">Delete</a>
                    </td>
                </tr>
